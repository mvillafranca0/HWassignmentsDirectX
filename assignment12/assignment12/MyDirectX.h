...
struct VERTEX
{
	...
	float nx, ny, nz;	// normal vector of triangle surface
    float tu, tv;		// texture vertex location
};
...
TERRAIN* CreateTerrain(string textureFileName, string heightFileName, float mapScale = 1);
